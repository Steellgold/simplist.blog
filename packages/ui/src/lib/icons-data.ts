...
export const iconsData: Array<{
...
}> = [
  {
    name: "tool-case",
    categories: ["design"],
    tags: ["tool", "case", "equipment"],
  },
  {
    name: "vector-square",
    categories: ["design"],
    tags: ["vector", "square", "geometry"],
  },
  {
    name: "bottle-wine",
    categories: ["design"],
    tags: ["wine", "bottle", "drink"],
  },
  {
    name: "line-squiggle",
    categories: ["design"],
    tags: ["line", "squiggle", "draw"],
  },
  {
    name: "squircle-dashed",
    categories: ["design"],
    tags: ["squircle", "dashed", "shape"],
  },
  {
    name: "georgian-lari",
    categories: ["text"],
    tags: ["currency", "lari", "georgian"],
  },
  {
    name: "spool",
    categories: ["design"],
    tags: ["spool", "thread", "sewing"],
  },
  {
    name: "drone",
    categories: ["layout"],
    tags: ["drone", "fly", "device"],
  },
  {
    name: "barrel",
    categories: ["design"],
  ...
  },
  {
    ...
    tags: ["wifi", "settings", "connection"],
  },
  {
    name: "rectangle-circle",
    categories: ["design"],
    tags: ["rectangle", "circle", "shape"],
  },
  {
    name: "card-sim",
    categories: ["layout"],
  ...
  },
  {
    ...
    categories: ["text"],
    tags: ["currency", "pound", "sterling"],
  },
  {
    name: "cloud-check",
    categories: ["navigation"],
    tags: ["cloud", "check", "sync"],
  },
  {
    name: "id-card-lanyard",
    categories: ["layout"],
    tags: ["id", "card", "lanyard"],
  },
  {
    name: "grid-3x2",
    categories: ["layout"],
    tags: ["grid", "layout", "3x2"],
  },
  {
    name: "check-line",
    categories: ["text"],
    tags: ["check", "line", "confirm"],
  },
  {
    name: "square-dashed-top-solid",
    categories: ["design"],
    tags: ["square", "dashed", "top"],
  },
  {
    name: "soap-dispenser-droplet",
    categories: ["design"],
    tags: ["soap", "dispenser", "droplet"],
  },
  {
    name: "panda",
    categories: ["design"],
    tags: ["panda", "animal", "cute"],
  },
  {
    name: "gpu",
    categories: ["design"],
    tags: ["gpu", "hardware", "graphics"],
  },
  {
    name: "clock-plus",
    categories: ["layout"],
    tags: ["clock", "plus", "time"],
  },
  {
    name: "brush-cleaning",
    categories: ["design"],
    tags: ["brush", "cleaning", "tool"],
  },
  {
    name: "hamburger",
    categories: ["design"],
    tags: ["hamburger", "food", "menu"],
  },
  {
    name: "wifi-pen",
    categories: ["design"],
  ...
  },
  {
    name: "truck-electric",
    categories: ["design"],
    tags: ["truck", "electric", "vehicle"],
  },
  {
    name: "user-lock",
    categories: ["social"],
    tags: ["user", "lock", "security"],
  },
  {
    name: "bow-arrow",
    categories: ["design"],
    tags: ["bow", "arrow", "weapon"],
  },
  {
    name: "decimals-arrow-left",
    categories: ["text"],
    tags: ["decimals", "arrow", "left"],
  },
  {
    name: "decimals-arrow-right",
    categories: ["text"],
    tags: ["decimals", "arrow", "right"],
  },
  {
    name: "rectangle-goggles",
    categories: ["design"],
    tags: ["rectangle", "goggles", "vision"],
  },
  {
    name: "shredder",
    categories: ["design"],
    tags: ["shredder", "paper", "destroy"],
  },
  {
    name: "bubbles",
    categories: ["design"],
    tags: ["bubbles", "air", "soap"],
  },
  {
    name: "brick-wall-fire",
    categories: ["design"],
    tags: ["brick", "wall", "fire"],
  },
  {
    name: "heart-plus",
    categories: ["social"],
    tags: ["heart", "plus", "like"],
  },
  {
    name: "heart-minus",
    categories: ["social"],
    tags: ["heart", "minus", "unlike"],
  },
  {
    name: "rotate-ccw-key",
    categories: ["design"],
  ...
  },
  {
    name: "spline-pointer",
    categories: ["design"],
    tags: ["spline", "pointer", "curve"],
  },
  {
    name: "banknote-arrow-down",
    categories: ["text"],
    tags: ["banknote", "arrow", "down"],
  },
  {
    name: "banknote-x",
    categories: ["text"],
    tags: ["banknote", "x", "cancel"],
  },
  {
    name: "saudi-riyal",
    categories: ["text"],
    tags: ["currency", "saudi", "riyal"],
  },
  {
    name: "clock-fading",
    categories: ["layout"],
    tags: ["clock", "fade", "time"],
  },
  {
    name: "shrimp",
    categories: ["design"],
    tags: ["shrimp", "food", "seafood"],
  },
  {
    name: "square-round-corner",
    categories: ["design"],
    tags: ["square", "rounded", "corner"],
  },
  {
    name: "a-arrow-down",
  ...
  },
  {
    ...
    tags: ["user", "profile", "avatar", "picture", "photo", "image"],
  },
  {
    name: "shield-alert",
    categories: [
