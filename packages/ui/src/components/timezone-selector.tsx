...
const TIMEZONES = [
  ...
  { value: "America/Anchorage", label: "America/Anchorage", offset: "UTC-09:00" },
  { value: "America/Los_Angeles", label: "America/Los Angeles", offset: "UTC-08:00" },
  ...
  { value: "America/Chihuahua", label: "America/Chihuahua", offset: "UTC-07:00" },
  ...
  { value: "America/Mexico_City", label: "America/Mexico City", offset: "UTC-06:00" },
  { value: "America/Monterrey", label: "America/Monterrey", offset: "UTC-06:00" },
  { value: "America/Guatemala", label: "America/Guatemala", offset: "UTC-06:00" },
  { value: "America/New_York", label: "America/New York", offset: "UTC-05:00" },
  { value: "America/Indiana/Indianapolis", label: "America/Indiana/Indianapolis", offset: "UTC-05:00" },
  ...
  { value: "America/Sao_Paulo", label: "America/Sao Paulo", offset: "UTC-03:00" },
  { value: "America/Argentina/Buenos_Aires", label: "America/Argentina/Buenos Aires", offset: "UTC-03:00" },
  { value: "America/Godthab", label: "America/Godthab", offset: "UTC-03:00" },
  { value: "America/Montevideo", label: "America/Montevideo", offset: "UTC-03:00" },
  { value: "Atlantic/South_Georgia", label: "Atlantic/South Georgia", offset: "UTC-02:00" },
  { value: "Atlantic/Azores", label: "Atlantic/Azores", offset: "UTC-01:00" },
  { value: "Atlantic/Cape_Verde", label: "Atlantic/Cape Verde", offset: "UTC-01:00" },
  ...
  { value: "Africa/Casablanca", label: "Africa/Casablanca", offset: "UTC+00:00" },
  ...
  { value: "Africa/Johannesburg", label: "Africa/Johannesburg", offset: "UTC+02:00" },
  ...
  { value: "Asia/Yekaterinburg", label: "Asia/Yekaterinburg", offset: "UTC+06:00" },
  ...
  { value: "Asia/Kuala_Lumpur", label: "Asia/Kuala Lumpur", offset: "UTC+08:00" },
  ...
  { value: "Australia/Adelaide", label: "Australia/Adelaide", offset: "UTC+09:30" },
  { value: "Australia/Darwin", label: "Australia/Darwin", offset: "UTC+09:30" },
  { value: "Australia/Brisbane", label: "Australia/Brisbane", offset: "UTC+10:00" },
  { value: "Australia/Sydney", label: "Australia/Sydney", offset: "UTC+10:00" },
  { value: "Australia/Melbourne", label: "Australia/Melbourne", offset: "UTC+10:00" },
  { value: "Pacific/Guam", label: "Pacific/Guam", offset: "UTC+10:00" },
  { value: "Pacific/Port_Moresby", label: "Pacific/Port Moresby", offset: "UTC+10:00" },
  ...
  { value: "Pacific/Tongatapu", label: "Pacific/Tongatapu", offset: "UTC+13:00" },
          ...
          <CommandList>
            ...
            <CommandGroup>
              {TIMEZONES.map((timezone) => (
                <CommandItem key={timezone.value} value={timezone.value} onSelect={handleSelect}>
                  <Check className={cn("mr-2 size-4", value === timezone.value ? "opacity-100" : "opacity-0")} />
                  <span className="flex-1">{timezone.label}</span>
                  <span className="text-muted-foreground text-xs">{timezone.offset}</span>
                </CommandItem>
              ))}
            </CommandGroup>
          </CommandList>
