...
const ReactivatePage = async () => {
  ...
  const hasPendingDeletion = !!scheduledAt && scheduledAt.getTime() > Date.now()
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 py-8 overflow-hidden">
        ...
        <CardContent className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              ...
              {scheduledAt ? ` (scheduled at ${scheduledAt.toLocaleString()})` : ""}.
            </AlertDescription>
          </Alert>

          <div className="text-sm text-muted-foreground space-y-2">
            <p>Cancel now to restore full access. If you do nothing, all projects, articles, analytics, and API keys will be removed.</p>
          </div>
        </CardContent>
