...
export const Enable2FADialog = ({ open, onOpenChange, onEnabled }: Enable2FADialogProps) => {
  ...
  const handlePasswordSubmit = async (data: PasswordInput) => {
    ...
    toast.promise(
      authClient.twoFactor.enable({ password: data.password }), {
  ...
  const handleVerifySubmit = async (data: VerifyCodeInput) => {
    setIsSubmitting(true)
    toast.promise(
      authClient.twoFactor.verifyTotp({ code: data.code }),
      {
  ...
  const stepConfig: Record<Step, { title: string; description: string }> = {
    ...
    backup: {
      ...
      description: "Save these backup codes in a safe place. You'll need them if you lose access to your authenticator.",
    },
  }
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        ...
        {step === "password" && (
          <>
            <form onSubmit={passwordForm.handleSubmit(handlePasswordSubmit)} id="password-form">
              <FieldGroup>
        ...
        {step === "verify" && qrCode && (
          <>
            <form onSubmit={verifyForm.handleSubmit(handleVerifySubmit)} id="verify-form">
              <FieldGroup>
            ...
            <DialogFooter className="flex flex-row justify-between! items-center">
              ...
              <div className="flex flex-row gap-2">
                ...
                <Button type="submit" form="verify-form" disabled={isSubmitting}>
