        ...
        <FieldSet>
          <FieldGroup>
            <Field>
              <InputGroup>
                <InputGroupAddon align="block-start">
                  <InputGroupButton variant="secondary" asChild>
                    <Link
                      href="https://docs.simplist.blog/webhooks"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Code />
              ...
              <FieldDescription>
                Leave empty to use the default generic payload. Variables:{" "}
                {"{title}"}, {"{slug}"}, {"{excerpt}"}, {"{author}"}, {"{tags}"}
                , {"{publishedAt}"}, {"{url}"}, {"{event}"}, {"{coverImage}"},{" "}
                {"{wordCount}"}, {"{characterCount}"}, {"{lineCount}"},{" "}
                {"{readTimeMinutes}"}, {"{variantCount}"}
              </FieldDescription>
            </Field>
          </FieldGroup>
        </FieldSet>
