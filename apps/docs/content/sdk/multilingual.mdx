...
<MethodSignature
  ...
  parameters={[
    { name: "article", type: "Article", required: true },
    { name: "userLang", type: "LanguageCode", optional: true },
    { name: "fallbackLang", type: "LanguageCode", optional: true },
  ]}
  returnType="ArticleVariant | Article"
/>
...
<MethodSignature
  ...
  parameters={[{ name: "article", type: "Article", required: true }]}
  returnType="LanguageCode[]"
/>
...
<MethodSignature
  ...
  parameters={[
    {
      name: "options",
      type: "{ defaultLanguage?: LanguageCode, userLanguage?: LanguageCode }",
      optional: true,
    },
  ]}
...
<ApiMethodTable
  methods={[
    {
      method: "getContent",
      description: "Get article content in preferred language",
      returns: "string",
    },
    {
      method: "getTitle",
      description: "Get article title in preferred language",
      returns: "string",
    },
    {
      method: "getExcerpt",
      description: "Get article excerpt in preferred language",
      returns: "string | null",
    },
    {
      method: "getFullContent",
      description: "Get complete article variant",
      returns: "ArticleVariant | Article",
    },
    {
      method: "getCoverImage",
      description: "Get cover image for variant",
      returns: "string | null",
    },
    {
      method: "getSelectedLanguage",
      description: "Get the selected language for article",
    ...
    },
    {
      ...
      description: "Update default fallback language",
      returns: "void",
    },
  ]}
/>
...
<CodeBlock
  ...
  export function LanguageSwitcher({ article }: { article: Article }) {
    ...
    {
      label: "ArticlePage (Server)",
      language: "tsx",
      filename: "app/blog/[slug]/page.tsx",
      code: `import { SimplistClient, getBestMatchingVariant, getAllLanguages } from "@simplist.blog/sdk";
  ...
  export default async function ArticlePage({
    ...
    // Get best matching variant with user's language
    const variant = getBestMatchingVariant(article, userLang as any)
...
<TypeTable
  ...
  properties={[
    ...
    },
    {
      name: "content",
      type: "string",
      description: "Translated content (Markdown)",
      required: true,
    },
    {
      name: "coverImage",
      type: "string | null",
      description: "Cover image for this variant",
    },
    {
      name: "wordCount",
      type: "number",
