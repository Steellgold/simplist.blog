...
<CodeBlock language="typescript" filename="get-best-variant.ts">
  ...
  const content = getBestMatchingVariant(article, 'en')
...
<ApiMethodTable
  ...
  methods={[
    { method: "getContent", description: "Get complete variant object", returns: "ArticleVariant | Article" },
    { method: "getTitle", description: "Get title in user's language", returns: "string" },
    { method: "getExcerpt", description: "Get excerpt in user's language", returns: "string | null" },
    { method: "getFullContent", description: "Get full content in user's language", returns: "string" },
    { method: "getCoverImage", description: "Get cover image in user's language", returns: "string | null" },
    { method: "getSelectedLanguage", description: "Get language of selected content", returns: "LanguageCode" },
    { method: "setUserLanguage", description: "Update user language preference", returns: "void" },
    { method: "setDefaultLanguage", description: "Update default language", returns: "void" }
  ]}
/>
...
<CodeBlock language="typescript" filename="language-switcher.tsx">
  {`
  'use client'
  ...
  items={[
    {
      ...
      answer: "Use the same URL for all languages and serve content based on Accept-Language header or user preference. This keeps SEO simple and avoids duplicate content issues."
    },
    {
      question: "How do I handle missing translations gracefully?",
      answer: "Always use getVariantOrDefault() which automatically falls back to your default language. This ensures users always see content even if a translation is incomplete."
    },
    {
      question: "Can I let users manually choose their language?",
      answer: "Yes! Store the preference in localStorage or cookies, then pass it to getVariant(). Override automatic detection with manual selection for better UX."
    }
  ]}
/>
